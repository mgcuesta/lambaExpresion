...
public class RandomWords {
  ...
  public List<String> createList(int listSize) {
    ...
    List<String> wordList = rand.ints(listSize,0,sourceWords.size()-1).mapToObj(posicion -> sourceWords.get(posicion)).collect(Collectors.toList());
  ...
  public List<String> allWords() {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<String> lista = r.createList(10);
        System.out.println("RESULTADO: "+lista.stream().collect(Collectors.joining(" ")));
    }
}